...
const DeleteButton: React.FC<{ filename: string; onDelete?: () => void }> = ({ filename, onDelete }) => {
    ...
    }} disabled={loading} color="error" >Delete{loading ? <>&nbsp;<CircularProgress size={22} /></> : null}</Button>
}
        ...
        >
            ...
            <TabPanel value={value} index={0}>
                <div>
                    ...
                    <List>
                        <ListItem><Button variant="outlined">Export Collection</Button></ListItem>
                        <ListItem><Button variant="outlined">Duplicate Collection</Button></ListItem>
                    </List>
                </div>
            </TabPanel>
